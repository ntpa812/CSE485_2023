...
<body>
   ...
   <main class="container-fluid nav-top-song">
        ...
        <div class="row main-color p-3">
            <!-- Lặp qua các bài hát để hiển thị -->
            <?php if (!empty($songs)): ?>
                        ...
                        <div class="card mb-2" style="width: 100%;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title text-center">
                                    <a href="index.php?controller=article&action=detail&id=<?= htmlspecialchars($song['ma_bviet']) ?>" class="text-decoration-none"><?= htmlspecialchars($song['ten_bhat']) ?></a>
                                </h5>
                            </div>
                        </div>
                    </div>
