...
create table tacgia ( ma_tgia int unsigned not null primary key, ten_tgia varchar(100) not null, hinh_tgia varchar(100) not null );

create table theloai ( ma_tloai int unsigned not null primary key, ten_tloai varchar(50) not null );

create table baiviet ( ma_bviet int unsigned not null primary key, tieude varchar(200) not null, ten_bhat varchar(100) not null, tomtat text not null, noidung text not null, ngayviet datetime not null, hinhanh varchar(200), ma_tloai int unsigned not null, ma_tgia int unsigned not null, foreign key (ma_tloai) references theloai(ma_tloai), foreign key (ma_tgia) references tacgia(ma_tgia) );
