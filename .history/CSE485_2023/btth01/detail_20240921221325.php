...
<body>
    <?php
        ...
        // Truy vấn thông tin chi tiết bài viết
        $query = "SELECT baiviet.tieude, baiviet.ten_bhat, baiviet.tomtat, baiviet.noidung, theloai.ten_tloai, tacgia.ten_tgia
                  FROM baiviet
        ...
        <div class="row mb-5">
            <div class="col-sm-4">
                <?php
                 ...
                 //   $imageFile = !empty($article['image']) ? $article['image'] : 'default.jpg';
              /*  ?>
                ...
                <img src="images/songs/<?php echo $imageFile; ?>" class="img-fluid" alt="<?php echo $article['ten_bhat']; ?>"> */
                    ...
                    // Kiểm tra xem bài hát có hình ảnh không và hình ảnh đó có tồn tại trong thư mục không
